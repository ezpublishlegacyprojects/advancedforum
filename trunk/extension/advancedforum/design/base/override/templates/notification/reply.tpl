...
{def $temp_name = $object.owner.data_map.nickname.data_text|wash()}
{else}
{def $temp_name = $object.owner.name|wash()}
{/if}

{set-block scope=root variable=subject}{$object.main_node.parent.name|wash()} [{ezini("SiteSettings","SiteURL")} - {$object.main_node.parent.main_node.name|wash()}]{/set-block}
